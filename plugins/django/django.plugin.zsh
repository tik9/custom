...
alias dr='dm runserver 0.0.0.0:80'
...
_managepy-commands() {
  ...
  commands=(
    ...
    'compilemessages:Kompiliert .po files nach .mo files für "gettext"'
    'createcachetable:Creates the table needed to use the SQL cache backend.'
    'createsuperuser:superuser erzeugen'
    'collectstatic:alle statischen Dateien in 1 Ordner'
    'dbshell:command-line client für die DATABASE_ENGINE.'
    "diffsettings:Unterschiede zwischen settings.py und Django's default Einstellungen"
    'dumpdata:Output the contents of the database as a fixture of the given format.'
    'flush:``sqlflush`` auf'
    'help:Hilfe'
    'inspectdb:Introspects the database tables in the given database and outputs a Django model module.'
    'loaddata:Installs the named fixture(s) in the database.'
    'makemessages:Alle Strings für die Übersetzung herausziehen'
